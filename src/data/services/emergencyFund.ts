...
export const emergencyFundData: ServiceData = {
  ...
  heroSection: {
    ...
    subtitle: 'Plan Your Insurance the Smart Way',
    description: 'Life is unpredictable, but your family \'s financial security doesn\'t have to be. Fydaa helps you choose the right insurance cover for your needs, so you can protect your health,income, and future.',
  ...
  videoSection: {
    ...
    description: 'Whether it\'s life, health, term, or asset insurance, Fydaa ensures you get the right cover, the right premium, and the right claim process. We analyse your needs, compare the best options in the market, and guide you towards the most cost-effective, comprehensive protection.',
    videoUrl: 'https://fydaa-v2.s3.ap-south-1.amazonaws.com/public/webVideos/8.+Emergency+Fund+Setup.mp4'
  },
