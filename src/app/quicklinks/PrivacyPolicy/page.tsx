            ...
            <main className="w-full flex flex-col items-center p-10 pt-20">
                ...
                <section className="flex flex-col items-start">
                    ...
                    <p>
                        ...
                        <a href="https://fydaa.com/">https://fydaa.com</a> and other sites we
                        own and operate.
                    </p>
                    <p>
                    ...
                    <p>This policy is effective as of 24 May 2022.</p>
                    <p className="text-black font-mono mt-4">Last updated: 24 May 2022</p>
                    <h3 className="text-bold text-xl mt-8">Information We Collect</h3>
                    <p>
                    ...
                    <h3 className="text-bold text-xl mt-8">Log Data</h3>
                    <p>
                    ...
                    <h3 className="text-bold text-xl mt-8">Personal Information</h3>
                    <p>
                    ...
                    <h3 className="text-bold text-xl mt-8">Legitimate Reasons for Processing Your Personal Information</h3>
                    <p>
                    ...
                    <h3 className="text-bold text-xl mt-8">Collection and Use of Information</h3>
                    <p>
                    ...
                    <ul>
                        ...
                        <li>
                            to run competitions, sweepstakes, and/or offer additional benefits to
                            you
                        </li>
                        <li>
                    ...
                    <h3 className="text-bold text-xl mt-8">Security of Your Personal Information</h3>
                    <p>
                    ...
                    <h3 className="text-bold text-xl mt-8">How Long We Keep Your Personal Information</h3>
                    <p>
                    ...
                    <h3 className="text-bold text-xl mt-8">Children’s Privacy</h3>
                    <p>
                    ...
                    <h3 className="text-bold text-xl mt-8">Disclosure of Personal Information to Third Parties</h3>
                    ...
                    <h3 className="text-bold text-xl mt-8">International Transfers of Personal Information</h3>
                    <p>
                        The personal information we collect is stored and/or processed in India,
                        or where we or our partners, affiliates, and third-party providers
                        maintain facilities.
                    </p>
                    <p>
                    ...
                    <h3 className="text-bold text-xl mt-8">Your Rights and Controlling Your Personal Information</h3>
                    <p>
                    ...
                    <h3 className="text-bold text-xl mt-8">Use of Cookies</h3>
                    <p>
                    ...
                    <h3 className="text-bold text-xl mt-8">Limits of Our Policy</h3>
                    <p>
                    ...
                    <h3 className="text-bold text-xl mt-8">Changes to This Policy</h3>
                    <p>
                    ...
                    <h3 className="text-bold text-xl mt-8">Contact Us</h3>
                    <p>
