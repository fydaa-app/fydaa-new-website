        ...
        <div>
            ...
            <main className="w-full flex flex-col items-center p-10 pt-20">
                <section className="flex flex-col items-start">
                    ...
                    <p>
                        By accessing http://web.fydaa.com, you agree to abide by these Terms of
                    ...
                    <p className="text-black font-mono mt-4">These Terms of Service were last updated on 24 May 2022.</p>
                    <h3 className="text-bold text-xl mt-8">Limitations of Use</h3>
                    <p>
                    ...
                    <h3 className="text-bold text-xl mt-8" >Right to Terminate</h3>
                    <p>
                    ...
                    <h3 className="text-bold text-xl mt-8" >Severance</h3>
                    <p>
                    ...
                    <h3 className="text-bold text-xl mt-8" >Governing Law</h3>
                    <p>
                        These Terms of Service are governed by and construed in accordance with
                        the laws of India. You irrevocably submit to the exclusive jurisdiction
