...
const Fydaaexperience = () => {
  ...
  return (
    <div className="bg-white w-full pb-8 sm:pb-12 md:pb-16 lg:pb-20 h-auto flex flex-col items-center pt-12 sm:pt-16 md:pt-20 lg:pt-28 mb-8 sm:mb-12 md:mb-16">
      ...
      <div className="flex flex-col md:flex-row items-center justify-center md:justify-between w-full max-w-xs sm:max-w-md md:max-w-4xl lg:max-w-5xl xl:max-w-6xl 2xl:max-w-7xl px-4 sm:px-6 md:px-8 lg:px-12 xl:px-16 2xl:px-20 mt-8 sm:mt-12 md:mt-16 lg:mt-20 space-y-8 md:space-y-0 md:gap-8 lg:gap-12">
        ...
        <div className="w-[200px] h-[380px] sm:w-[220px] sm:h-[420px] md:w-[240px] md:h-[460px] lg:w-[266px] lg:h-[502px] bg-black rounded-[20px] sm:rounded-[25px] md:rounded-[30px] lg:rounded-[39px] order-1 md:order-1 lg:order-1 md:ml-24 lg:ml-28 xl:ml-40"></div>
        ...
        <div className="flex flex-col space-y-4 sm:space-y-5 md:space-y-6 lg:space-y-8 max-w-full md:max-w-sm lg:max-w-md order-2 md:order-2 lg:order-2 md:mr-12 lg:mr-24 xl:mr-20">
          ...
          <div className="flex items-center space-x-3 sm:space-x-4 relative">
            ...
            <div className={`w-1 h-6 sm:h-7 md:h-8 ${activeFeature === 0 ? 'bg-black' : 'bg-gray-400'} z-10`}></div>
            <span className={`font-['Inter'] text-[14px] sm:text-[15px] md:text-[16px] font-medium ${activeFeature === 0 ? 'text-black' : 'text-gray-500'} z-10`}>
          ...
          <div className="flex items-center space-x-3 sm:space-x-4 relative">
            ...
            <div className={`w-1 h-6 sm:h-7 md:h-8 ${activeFeature === 1 ? 'bg-black' : 'bg-gray-400'} z-10`}></div>
            <span className={`font-['Inter'] text-[14px] sm:text-[15px] md:text-[16px] font-medium ${activeFeature === 1 ? 'text-black' : 'text-gray-500'} z-10`}>
          ...
          <div className="flex items-center space-x-3 sm:space-x-4 relative">
            ...
            <div className={`w-1 h-6 sm:h-7 md:h-8 ${activeFeature === 2 ? 'bg-black' : 'bg-gray-400'} z-10`}></div>
            <span className={`font-['Inter'] text-[14px] sm:text-[15px] md:text-[16px] font-medium ${activeFeature === 2 ? 'text-black' : 'text-gray-500'} z-10`}>
              Set Realistic Goals
            </span>
          </div>
          ...
          <div className="flex items-center space-x-3 sm:space-x-4 relative">
            ...
            <div className={`w-1 h-6 sm:h-7 md:h-8 ${activeFeature === 3 ? 'bg-black' : 'bg-gray-400'} z-10`}></div>
            <span className={`font-['Inter'] text-[14px] sm:text-[15px] md:text-[16px] font-medium ${activeFeature === 3 ? 'text-black' : 'text-gray-500'} z-10`}>
          ...
          <div className="flex items-center space-x-3 sm:space-x-4 relative">
            ...
            <div className={`w-1 h-6 sm:h-7 md:h-8 ${activeFeature === 4 ? 'bg-black' : 'bg-gray-400'} z-10`}></div>
            <span className={`font-['Inter'] text-[14px] sm:text-[15px] md:text-[16px] font-medium ${activeFeature === 4 ? 'text-black' : 'text-gray-500'} z-10`}>
          ...
          <div className="flex items-center space-x-3 sm:space-x-4 relative">
            ...
            <div className={`w-1 h-6 sm:h-7 md:h-8 ${activeFeature === 5 ? 'bg-black' : 'bg-gray-400'} z-10`}></div>
            <span className={`font-['Inter'] text-[14px] sm:text-[15px] md:text-[16px] font-medium ${activeFeature === 5 ? 'text-black' : 'text-gray-500'} z-10`}>
              Track and Tweak
            </span>
          </div>
