...
// Define props interface for FlipCard
...
const FlipCard: React.FC<FlipCardProps> = ({ card, onClick, isFlipped }) => {
  const cardStyle = {
    background:
          ...
          <div className="card-front">
            ...
            >
              ...
              <div className="flex flex-col items-start space-y-8 sm:space-y-12 md:space-y-14 lg:space-y-16 relative z-10">
                <div
                  className={`w-[50px] h-[60px] sm:w-[70px] sm:h-[85px] md:w-[75px] md:h-[90px] lg:w-[80px] lg:h-[100px] relative mt-2 sm:mt-3 md:mt-4 ${
                    card.iconScale === "scale-150"
                      ? "w-[80px] h-[100px] pl-1 pt-1"
                      : ""
                  }`}
                >
                  <img
