...
const FAQ: React.FC = () => {
  ...
  const faqData = [
    {
      question: "How do I know how much insurance cover I need?",
      answer: "A general rule is 10–15 times your annual income for life insurance, plus adequate health cover for all family members."
    },
    {
      question: "Is term insurance better than life insurance?",
      answer: "Term insurance is more affordable and gives higher coverage, while life insurance includes an investment component."
    },
    {
      question: "How often should I review my insurance?",
      answer: "At least once a year or when there’s a major life change (marriage, new child, home purchase)."
    },
    {
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16">
          ...
          <div className="space-y-8">
            <div>
              ...
              Get the right insurance plan with Fydaa. Compare, choose, and secure the best coverage for life, health, and assets in India with expert guidance and claim support.
              </p>
            </div>
