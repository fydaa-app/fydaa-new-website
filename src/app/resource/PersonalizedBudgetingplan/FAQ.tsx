...
const FAQ: React.FC = () => {
  ...
  const faqData = [
    {
      question: "How is a personalized budget different from a regular budget?",
      answer: "TIt’s designed around your unique income, spending habits, and goals, so it’s realistic and easier to stick to."
    },
    {
      question: "Can I still enjoy my lifestyle with a budget?",
      answer: "Absolutely! A good budget allows for essentials, savings, and leisure without guilt."
    },
    {
      question: "How often should I review my budget?",
      answer: "Review it monthly or whenever there’s a major change in your income or expenses."
    },
    {
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16">
          ...
          <div className="space-y-8">
            <div>
              ...
              Get a personalized budgeting plan with Fydaa that fits your income, lifestyle, and goals. Save more, spend smart, and reach your dreams faster with a budget that works for you.
              </p>
            </div>
