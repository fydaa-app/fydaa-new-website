...
const FAQ: React.FC = () => {
  ...
  const faqData = [
    {
      question: "What Is The Best Way To Manage Multiple Loans In India?",
      answer: "The best way is to consolidate them into a single loan with a lower interest rate or choose a repayment strategy like debt snowball or avalanche. Fydaa helps you choose the right option based on your profile."
    },
    {
      question: "How Does Refinancing A Loan Help Me Save Money?",
      answer: "Refinancing can lower your interest rate, reduce your EMI, or shorten your loan tenure—saving you money over time."
    },
    {
      question: "Will Debt Management Affect My Credit Score?",
      answer: "If done correctly, it can actually improve your score by ensuring timely payments and reducing credit utilization."
    },
    {
            ...
            <div className="space-y-8">
              <div>
                ...
                <p className="font-['Inter'] font-normal text-[18px] text-gray-700 leading-relaxed">
                  Manage your debt smarter with Fydaa. Get personalized debt management plans, refinancing options, and expert tips to reduce EMIs, lower interest rates, and improve your credit score in India.
                </p>
              </div>
