        ...
        <div className="w-full mx-0 px-0 relative">
          <div className="text-left mt-16 mx-0 px-0">
            ...
            <div className="space-y-6 relative z-20 mx-0 px-0">
              <div className="flex flex-col md:flex-row justify-between items-start mx-0 px-0">
                <div className="flex-1 relative z-30 mx-0 px-0">
                  <h1 className="text-3xl sm:text-4xl md:text-5xl lg:text-6xl font-bold text-gray-900 pl-4 sm:pl-8 md:pl-12 lg:pl-[50px] leading-tight font-gilroy">
                    Take Control of Your Debt, <br /> Regain Your Peace of Mind
                  </h1>
                  <p className="text-base sm:text-lg text-gray-700 pl-4 sm:pl-8 md:pl-12 lg:pl-[50px] leading-relaxed font-inter">
            ...
            <div className="mt-[200px] relative z-0 flex justify-center overflow-visible mx-0 px-0 w-full">
              <div className="mt-[200px] relative z-0 flex justify-center overflow-visible mx-0 px-0 w-full pb-[300px] md:pb-[200px]">
                <img
                ...
                <div className="absolute inset-0 flex flex-col items-center justify-center text-center pt-[100px] pb-[60px]">
                  <h2 className="text-2xl sm:text-3xl md:text-4xl lg:text-[44px] font-bold text-white mb-4 sm:mb-4 md:mb-[16px] leading-tight font-gilroy">
                    Make Your Debt Work for You, Not Against You
                  </h2>
                  <p className="text-sm sm:text-base md:text-[16px] text-gray-200 max-w-full sm:max-w-[700px] md:max-w-[900px] lg:max-w-[1100px] leading-relaxed mb-10 sm:mb-10 md:mb-[40px] font-inter">
                  ...
                  {/* Video Placeholder */}
                  <div className="bg-gray-800 rounded-2xl p-6 sm:p-8 shadow-2xl relative overflow-hidden w-full max-w-[700px] mb-8 sm:mb-10">
                    {/* Video Screen */}
