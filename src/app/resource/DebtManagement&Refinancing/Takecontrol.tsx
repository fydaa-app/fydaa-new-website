            ...
            <div className="space-y-6 relative z-20">
              <div className="flex justify-between items-start">
                <div className="flex-1 relative z-30">
                  ...
                  Struggling with EMIs, credit card dues, or multiple loans? You’re not alone. Fydaa helps you <br />
                   simplify your repayments, lower your interest rates, and get your finances back on track, <br />
            ...
            <div className="mt-[350px] relative z-0 flex justify-center overflow-visible">
              <div className="relative overflow-visible">
                ...
                <div className="absolute inset-0 flex flex-col items-center justify-start text-center ">
                  ...
                  Debt management and refinancing are not just about paying off what you owe, they’re about creating a repayment plan that works 
                  for your lifestyle and future goals. At Fydaa, we guide you through smart repayment strategies, consolidation options, and 
