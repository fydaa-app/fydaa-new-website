              ...
              <div className="flex flex-col lg:flex-row gap-6 lg:gap-8 items-start">
                ...
                <div className="flex-1">
                  <h1 className="text-6xl font-bold text-gray-900 pl-[50px] leading-tight font-gilroy">
                    Your Financial Health Matters – <br />
                    Let's Check It
                  </h1>
                  <p className="text-lg text-gray-700 pl-[50px] leading-relaxed font-inter mt-4">
                    Just like a regular health check keeps your body fit, a
                    financial health check keeps your <br />
                    money in shape. Fydaa helps you understand where you stand
                    financially and guides you <br />
                    towards a stronger, stress-free future.
                  </p>
                ...
                <div className="flex-shrink-0 -mt-[150px]">
                  <img
                    src="/resource/FinancialHealthCheckup/icon.png"
              ...
              <div className="relative overflow-visible w-full mx-0 px-0">
                ...
                <div className="absolute inset-0 flex flex-col items-center justify-center text-center pt-[100px] pb-[60px]">
                  <h2 className="text-[44px] font-bold text-white mb-[16px] leading-tight font-gilroy">
                    Know Your Financial Score Before You Plan Your Future
                  </h2>
                  <p className="text-[16px] text-gray-200 max-w-[1100px] leading-relaxed mb-[40px] font-inter">
                    Our financial health check looks at your income, savings,
                    expenses, debts, and investments — giving you a clear
                    picture of your financial strengths and gaps. With this, you
                    can take action today for a more secure tomorrow.
                  </p>
