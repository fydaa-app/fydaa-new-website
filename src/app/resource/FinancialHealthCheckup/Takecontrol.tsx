            ...
            <div className="space-y-6 relative z-20 mx-0 px-0">
              <div className="flex justify-between items-start mx-0 px-0">
                <div className="flex-1 relative z-30 mx-0 px-0">
                  ...
                  Just like a regular health check keeps your body fit, a financial health check keeps your <br />
                  money in shape. Fydaa helps you understand where you stand financially and guides you <br />
