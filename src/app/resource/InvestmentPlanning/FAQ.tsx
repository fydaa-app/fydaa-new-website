  ...
  const faqData = [
    {
      ...
      answer: "It ensures your money grows in a way that matches your goals and protects you from inflation."
    },
    {
      question: "Can I start with a small amount?",
      answer: "Yes! Even small monthly investments grow significantly over time through compounding."
    },
    {
      question: "How do I know which investment is right for me?",
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16">
          ...
          <div className="space-y-8">
            <div>
              ...
              Fydaa offers personalised investment planning in India. Achieve your financial goals with the right mix of investments based on your risk profile and time horizon.
              </p>
            </div>
