              ...
              <div className="space-y-12">
                ...
                <div className="flex items-start gap-6">
                  ...
                  <div>
                    ...
                    <p className="font-['Inter'] text-[16px] text-gray-600">
                      Equity, debt, mutual funds, gold, or real estate.
                    </p>
                  </div>
                </div>
                ...
                <div className="flex items-start gap-6">
                  ...
                  <div>
                    ...
                    <p className="font-['Inter'] text-[16px] text-gray-600">
                      Begin with the right amount and increase gradually.
                    </p>
                  </div>
                </div>
                ...
                <div className="flex items-start gap-6">
                  ...
                  <div>
                    ...
                    <p className="font-['Inter'] text-[16px] text-gray-600">
                      Make adjust ments as your goals or market conditions
                      change.{" "}
                    </p>
                  </div>
                </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-16 max-w-6xl mx-auto">
            ...
            <div className="text-center">
              ...
              <p className="text-gray-600 text-lg">
                Fund big milestones without stress
              </p>
            </div>
