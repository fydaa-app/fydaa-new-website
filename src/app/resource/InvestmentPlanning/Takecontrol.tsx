            ...
            <div className="space-y-6 relative z-20 mx-0 px-0">
              <div className="flex justify-between items-start mx-0 px-0">
                <div className="flex-1 relative z-30 mx-0 px-0">
                  ...
                  Whether you're saving for your dream home, your child's education, or early retirement, <br />
                   Fydaa's investment planning makes sure your money works as hard as you do.
                  </p>
                </div>
