              ...
              <div className="flex flex-col lg:flex-row gap-6 lg:gap-8 items-start">
                ...
                <div className="flex-1">
                  <h1 className="text-6xl font-bold text-gray-900 pl-[50px] leading-tight font-gilroy">
                    Grow Your Money, Secure Your <br /> Future
                  </h1>
                  <p className="text-lg text-gray-700 pl-[50px] leading-relaxed font-inter mt-4">
                    Whether you're saving for your dream home, your child's
                    education, or early retirement, <br />
                    Fydaa's investment planning makes sure your money works as
                    hard as you do.
                  </p>
                ...
                <div className="flex-shrink-0 -mt-[150px]">
                  <img
                    src="/resource/InvestmentPlanning/icon.png"
              ...
              <div className="relative overflow-visible w-full mx-0 px-0">
                ...
                <div className="absolute inset-0 flex flex-col items-center justify-center text-center pt-[100px] pb-[60px]">
                  ...
                  <p className="text-[16px] text-gray-200 max-w-[1100px] leading-relaxed mb-[40px] font-inter">
                    Investment planning isn't just about picking random
                    schemes—it's about matching the right products to your
                    goals, risk level, and time frame. Fydaa's experts and tools
                    help you choose wisely so you can grow your wealth with
                    confidence.
                  </p>
