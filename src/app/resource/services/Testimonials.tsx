...
const Testimonials: React.FC<TestimonialsProps> = ({ testimonials }) => {
  ...
  const extendedTestimonials = [
    testimonials[testimonials.length - 1], // Clone of last card
    ...testimonials,
    testimonials[0], // Clone of first card
  ];
  ...
  const renderTestimonialCard = (
    testimonial: ServiceData["testimonials"][0],
    index: number
  ) => (
    <div
    ...
    >
      <div className="bg-[#101828]/10 backdrop-blur-sm rounded-2xl p-4 sm:p-6 md:p-8 shadow-lg border border-gray-300/20 flex flex-col relative transition-all duration-500 ease-in-out mx-auto overflow-hidden h-[220px] sm:h-[260px] md:h-[300px] lg:h-[340px] xl:h-[370px] 2xl:h-[450px] max-w-[280px] sm:max-w-[320px] md:max-w-[360px] lg:max-w-[400px] xl:max-w-[450px] 2xl:max-w-[550px]">
