...
interface VideoSectionProps {
  data: ServiceData["videoSection"];
}

const VideoSection: React.FC<VideoSectionProps> = ({ data }) => {
  return (
    <section className="relative z-30 mt-20 sm:mt-20 md:mt-28 lg:mt-40 xl:mt-48 2xl:mt-56 flex justify-center overflow-visible pointer-events-none pb-[25px] sm:pb-[30px] md:pb-[35px] lg:pb-[40px] xl:pb-[45px] 2xl:pb-[50px]">
      <div className="relative w-full max-w-screen-4xl mx-auto">
        <div className="relative w-full">
          ...
          <img
            ...
            className="absolute inset-x-0 top-0 w-full h-[1500px] object-cover pointer-events-none -z-10"
          />

          <div className="relative z-20 flex flex-col items-center text-center px-2 sm:px-4 md:px-6 lg:px-8 pointer-events-auto">
            <div className="flex flex-col items-center max-w-full sm:max-w-[600px] md:max-w-[800px] lg:max-w-[1100px] mx-auto px-4">
              ...
              <p className="text-justify md:text-center text-[#E6E6E6] font-inter font-normal text-[12px] pt-[10px] pb-[20px] sm:pt-[12px] sm:pb-[24px] md:pt-[14px] md:pb-[28px] lg:pt-[16px] lg:pb-[32px] xl:pt-[18px] xl:pb-[36px] 2xl:pt-[20px] 2xl:pb-[40px] sm:text-[13px] md:text-[14px] lg:text-[15px] xl:text-[16px] 2xl:text-[18px] 3xl:text-[20px] leading-[18px] sm:leading-[19px] md:leading-[20px] lg:leading-[22px] xl:leading-[24px] 2xl:leading-[26px] 3xl:leading-[28px] tracking-[-0.36px] max-w-[280px] sm:max-w-[400px] md:max-w-[550px] lg:max-w-[800px] xl:max-w-[1100px] 2xl:max-w-[1400px] 3xl:max-w-[1800px] mx-auto mb-3 sm:mb-4 md:mb-6 lg:mb-[32px] xl:mb-[40px] 2xl:mb-[48px] 3xl:mb-[56px]">
                {data.description}
              </p>
            </div>
