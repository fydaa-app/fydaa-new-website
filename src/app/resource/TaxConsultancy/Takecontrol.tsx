              ...
              <div className="flex flex-col lg:flex-row gap-6 lg:gap-8 items-start">
                ...
                <div className="flex-1">
                  <h1 className="text-6xl font-bold text-gray-900 pl-[50px] leading-tight font-gilroy">
                    Pay the Right Taxes – and Save <br />
                    More Legally
                  </h1>
                  <p className="text-lg text-gray-700 pl-[50px] leading-relaxed font-inter mt-4">
                    Tax planning isn't about avoiding taxes—it's about
                    optimising them. Fydaa helps you <br />
                    understand the rules, claim eligible deductions, and plan
                    your finances to keep more <br />
                ...
                <div className="flex-shrink-0 -mt-[150px]">
                  <img
                    src="/resource/TaxConsultancy/icon.png"
                    alt="Tax Planning"
              ...
              <div className="relative overflow-visible w-full mx-0 px-0">
                ...
                <div className="absolute inset-0 flex flex-col items-center justify-center text-center pt-[100px] pb-[60px]">
                  ...
                  <p className="text-[16px] text-gray-200 max-w-[1100px] leading-relaxed mb-[40px] font-inter">
                    From filing returns to planning investments for tax
                    benefits, Fydaa's tax consultancy ensures you comply with
                    Indian tax laws while maximising your savings. We keep you
                    updated with the latest rules so you never miss an
                    opportunity.
                  </p>
                  ...
                  <div className="bg-gray-800 rounded-2xl p-[24px] shadow-2xl relative overflow-hidden w-[700px] mb-[30px]">
                    ...
                    {/* Video Controls */}
                    <div className="flex items-center justify-between bg-gray-700 rounded-lg p-2 sm:p-3 md:p-4">
