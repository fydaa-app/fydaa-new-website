            ...
            <div className="space-y-6 relative z-20 mx-0 px-0">
              <div className="flex justify-between items-start mx-0 px-0">
                <div className="flex-1 relative z-30 mx-0 px-0">
                  ...
                  Tax planning isn’t about avoiding taxes—it’s about optimising them. Fydaa helps you <br />
                   understand the rules, claim eligible deductions, and plan your finances to keep more <br />
                    ...
                    <div className="flex items-center justify-between bg-gray-700 rounded-lg p-2 sm:p-3 md:p-4">
                      ...
                      <div className="flex-1 mx-2 sm:mx-3 md:mx-4">
                        <div className="w-full bg-gray-600 rounded-full h-1 sm:h-2">
                          <div className="bg-red-500 h-1 sm:h-2 rounded-full" style={{ width: '45%' }}></div>
                        </div>
                      </div>
