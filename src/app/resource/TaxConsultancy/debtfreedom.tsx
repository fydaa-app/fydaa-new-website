            ...
            <div className="flex-1 max-w-[650px]">
              ...
              <div className="space-y-12">
                <div className="flex items-start gap-6">
                  ...
                  <div>
                    <h3 className="font-['Inter'] font-normal text-[20px]">Assess Your Income Sources</h3>
                    <p className="font-['Inter'] text-[16px] text-gray-600">Salary, business, investments, rentals.</p>
                  </div>
                </div>
                ...
                <div className="flex items-start gap-6">
                  ...
                  <div>
                    <h3 className="font-['Inter'] font-normal text-[20px]">Identify Tax-Saving Opportunities</h3>
                    <p className="font-['Inter'] text-[16px] text-gray-600">Sections 80C, 80D, 24B, and more.</p>
                  </div>
                </div>
                ...
                <div className="flex items-start gap-6">
                  ...
                  <div>
                    <h3 className="font-['Inter'] font-normal text-[20px]">Optimise Investments</h3>
                    <p className="font-['Inter'] text-[16px] text-gray-600">Choose tax-efficient instruments like ELSS, PPF, NPS.</p>
                  </div>
                </div>
                ...
                <div className="flex items-start gap-6">
                  ...
                  <div>
                    <h3 className="font-['Inter'] font-normal text-[20px]">Ensure Compliance</h3>
                    <p className="font-['Inter'] text-[16px] text-gray-600">File returns accurately and on time.</p>
                  </div>
                </div>
                ...
                <div className="flex items-start gap-6">
                  ...
                  <div>
                    ...
                    <p className="font-['Inter'] text-[16px] text-gray-600">Adjust your plan with changes in tax laws or income.</p>
                  </div>
                </div>
              </div>
            </div>
