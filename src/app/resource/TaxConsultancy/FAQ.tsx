  ...
  const faqData = [
    {
      ...
      answer: "It’s the professional management of your investments to meet specific goals."
    },
    {
      question: "Do I need it if I invest on my own?",
      answer: "Yes, if you want expert strategies, regular rebalancing, and market insights to maximise returns."
    },
    {
      question: "How often should my portfolio be reviewed?",
      answer: "Ideally, every 6–12 months or during major market changes."
    },
    {
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16">
          ...
          <div className="space-y-8">
            <div>
              ...
              Fydaa’s portfolio management services help you optimise, diversify, and grow your investments in India with expert guidance and regular performance tracking.
              </p>
            </div>
