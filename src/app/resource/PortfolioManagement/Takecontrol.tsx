              ...
              <div className="flex flex-col lg:flex-row gap-6 lg:gap-8 items-start">
                ...
                <div className="flex-1">
                  ...
                  <p className="text-lg text-gray-700 pl-[50px] leading-relaxed font-inter mt-4">
                    From tracking to growing, we handle it all. We monitor your
                    investments, rebalance your <br />
                    portfolio, and suggest changes based on market trends and
                    your evolving needs. All you <br />
                ...
                <div className="flex-shrink-0 -mt-[150px]">
                  <img
                    src="/resource/PortfolioManagement/icon.png"
