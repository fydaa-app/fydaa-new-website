              ...
              <div className="flex flex-col lg:flex-row gap-6 lg:gap-8 items-start">
                ...
                <div className="flex-1">
                  ...
                  <p className="text-lg text-gray-700 pl-[50px] leading-relaxed font-inter mt-4">
                    From monthly groceries to weekend splurges, small expenses
                    can add up quickly. Fydaa <br />
                    helps you stay in control of your money—so you spend smart,
                    save more, and still enjoy <br />
                ...
                <div className="flex-shrink-0 -mt-[150px]">
                  <img
                    src="/resource/ExpenseManagement/icon.png"
              ...
              <div className="relative overflow-visible w-full mx-0 px-0">
                ...
                <div className="absolute inset-0 flex flex-col items-center justify-center text-center pt-[100px] pb-[60px]">
                  ...
                  <p className="text-[16px] text-gray-200 max-w-[1100px] leading-relaxed mb-[40px] font-inter">
                    Expense management isn't about restricting yourself—it's
                    about making your money work for what truly matters. Fydaa's
                    smart tools help you track every rupee, identify wasteful
                    spends, and set budgets you can actually stick to.
                  </p>
